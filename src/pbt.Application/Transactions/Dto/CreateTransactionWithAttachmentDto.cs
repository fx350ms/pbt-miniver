...
{
    public class CreateTransactionWithAttachmentDto : FullAuditedEntityDto<long>
    {
    ...
    public class CreateCustomerTransactionWithAttachmentDto : FullAuditedEntityDto<long>
    {
        ...
        public int CustomerTransactionUpdateType { get; set; } //  3. Cộng ví, 4. Trừ ví
        public string Files { get; set; } // Danh sách file đính kèm. Lưu dạng json với format: Id và Name 
