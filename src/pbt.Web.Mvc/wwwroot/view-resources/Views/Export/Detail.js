(function ($) {
    ...
    // async function getBagToday() {
    //     return await abp.services.app.bag.getBagsToday().done(function (data) {
  ...
  `);
    ...
    function loadDeliveryNoteLogs() {
        var deliveryNoteId = $("[name='deliveryNoteId']").val();
        return abp.services.app.entityChangeLogger.getLogs('DeliveryNote', deliveryNoteId).done(function (data) {
