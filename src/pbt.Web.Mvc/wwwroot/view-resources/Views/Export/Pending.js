        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    return [
                        `   <a href="/bags/bagging/${row.id}" type="button" class="btn btn-sm btn-outline" data-bag-id="${row.id}">`,
            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    return [
                        `   <a href="/bags/detail/${row.id}" type="button" class="btn btn-sm bg-secondary" data-department-id="${row.id}">`,
