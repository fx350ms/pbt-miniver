            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    ...
                    return [
                        ...
                        '   </a>',
                        `   <a type="button" class="dropdown-item text-info edit-amount" data-customer-id="${row.id}" data-toggle="modal" data-target="#CustomerUpdateAmountModal" title="${l('EditAmount')}">`,
                        `       <i class="fas fa-coins"></i> ${l('EditAmount')}`,
                        '   </a>',
                        `   <a target="_blank" href="/Customers/CreateTransaction?customerId=${row.id}" type="button" class="dropdown-item text-success edit-balance-history" data-customer-id="${row.id}"   title="${l('Finance')}">`,
                        `       <i class="fas fa-money-check"></i> ${l('CreateTransaction')}`,
                        '   </a>',
                        `   <a target="_blank" href="/Customers/Finance/${row.id}" class="dropdown-item text-success edit-balance" data-customer-id="${row.id}"   title="${l('FinanceBalance')}">`,
                        `       <i class="fas fa-money-check"></i> ${l('TransactionHistory')}`,
                        '   </a>',
                        `   <a type="button" class="dropdown-item select-shipping-rate text-info" data-customer-id="${row.id}" data-toggle="modal"  data-name="${row.username}" data-target="#CustomerSelectShippingRateGroup" title="${l('SelectShippingRate')}">  `,
                        `       <i class="fas fa-money-check-alt"></i> ${l('ShippingRate')}`,
                        '   </a>',
                        ...
                        `   <a type="button" class="dropdown-item update-max-debt text-info" data-customer-id="${row.id}"  data-toggle="modal" data-target="#CustomerUpdateMaxDebt" data-customer-name="${row.name}" title="${l('UpdateDebtMax')}">  `,
                        `       <i class="fas fa-credit-card"></i> ${l('UpdateDebtMax')}`,
                        '   </a>',
                        btnChildCustomer,
