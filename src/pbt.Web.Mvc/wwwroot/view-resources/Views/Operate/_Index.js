(function ($) {
    var _warehouseService = abp.services.app.package,
    ...
    var _$departmentsTable = _$table.DataTable({
        ...
        listAction: {
            ajaxFunction: _warehouseService.getPackagesFilter,
        ...
        columnDefs: [
            ...
            {
                targets: 9,
                data: 'deliveryTimeFormat',
                sortable: false
            },
            {
                targets: 10,
                data: 'warehouseStatusName',
                sortable: false
            },
            {
                targets: 11,
            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    return [
                        `   <a href="" type="button" class="btn btn-sm bg-secondary edit-department" data-department-id="${row.id}">`,
