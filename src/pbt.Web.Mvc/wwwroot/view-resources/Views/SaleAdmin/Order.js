        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    return [
                        `   <a  target="_blank" data-order-id="${row.id}" href="/Orders/Detail/${row.id}" >`,
...

            {
                ...
                render: (data, type, row, meta) => {
                    return [
                        `   <a target="_blank" type="button" class="btn btn-sm bg-primary " data-order-id="${row.id}" href="/SaleAdmin/CustomerDetail/${row.id}" >`,
